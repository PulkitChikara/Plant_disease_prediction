...
def clean_image(image):
    ...
    # Resizing the image
    image = np.array(Image.fromarray(image).resize((512, 512), resample=Image.Resampling.LANCZOS))
    # Adding batch dimensions to the image
    # You are setting :3, that's because sometimes user uploads a 4 channel image,
